...
corpus <- Corpus(VectorSource(readLines("~/2023 Fall/Consulting class/Aided_AAC_Analysis/all/T4101.txt")))
...
#Turn core words into a dataframe including commonality and frequency
core_words_all_chart <- data.frame('Composite frequency' = colSums(core_words_all), 'Commonality' = colSums(1*(core_words_all > 0))/num_all)
